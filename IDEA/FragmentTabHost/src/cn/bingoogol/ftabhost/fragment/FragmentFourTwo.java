...
public class FragmentFourTwo extends Fragment {
    private static final String TAG = "FragmentFourTwo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_four_two, container, false);
    }
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        TextView tv_four_two = (TextView)getView().findViewById(R.id.tv_four_two);
        tv_four_two.setText("four two " + flag);
